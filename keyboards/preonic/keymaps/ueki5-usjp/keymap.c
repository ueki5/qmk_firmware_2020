...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  _______, _______, _______, _______, _______, _______, U_TOP,   KC_HOME, KC_UP,   KC_END,  U_BTM,   _______,  \
  _______, LCTLA,   LCTLS,   KC_LCTL, KC_LSFT, _______, KC_BSPC, KC_LEFT, KC_DOWN, KC_RGHT, KC_DEL,  _______, \
  _______, LCTLZ,   LCTLX,   LCTLC,   LCTLV,   _______, KC_ESC,  KC_PGDN, KC_PSCR, KC_PGUP, _______, _______, \
...
[_RAISE] = LAYOUT_preonic_grid( \
  KC_F11,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F12, \
  _______, JP_MINS,JP_UNDS,  JP_LCBR, JP_RCBR, JP_GRV,  _______, _______, _______, _______, _______, _______,  \
  _______, JP_EQL, JP_PLUS,  JP_LBRC, JP_RBRC, JP_TILD, _______, KC_LSFT, KC_RCTL, _______, _______, _______, \
...
[_ADJUST] = LAYOUT_preonic_grid( \
  ...
  _______, _______, _______, _______, _______, JP_ZKHK, JP_ZKHK, _______, _______, _______, _______, _______  \
)
