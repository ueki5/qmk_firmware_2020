...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_all(
        KC_ESC, KC_1,    KC_2,    KC_3,   KC_4,   KC_5,   KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, JP_EQL,  KC_BSPC, JP_GRV,
        KC_TAB, KC_Q,    KC_W,    KC_E,   KC_R,   KC_T,   KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    JP_LBRC, JP_RBRC, KC_JYEN, KC_DEL,
        KC_LCTL,KC_A,    KC_S,    KC_D,   KC_F,   KC_G,   KC_H,    KC_J,    KC_K,    KC_L,    JP_SCLN, JP_QUOT, CTL_T(KC_ENT),  KC_PGUP,
        KC_LSFT,KC_Z,    KC_X,    KC_C,   KC_V,   KC_B,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_LSFT, KC_UP,   KC_PGDOWN,
        KC_NO,  KC_LGUI, KC_LALT, LT(LOWER,JP_MHEN),   KC_SPC,    LT(UPPER,JP_HENK),  KC_LALT, KC_LCTL, KC_NO,  KC_LEFT, KC_DOWN, KC_RIGHT),
    [LOWER] = LAYOUT_all(
        KC_TRNS,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_TRNS,  JP_ZKHK,
