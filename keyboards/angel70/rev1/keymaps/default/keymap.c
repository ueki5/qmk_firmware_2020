...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_all(
        ...
        KC_LSFT,KC_Z,    KC_X,    KC_C,   KC_V,   KC_B,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_NO,   KC_UP,   KC_PGDOWN,
        KC_1, KC_LGUI, KC_LALT,   KC_2,   KC_NO, KC_SPC,  KC_3,    KC_NO,   KC_RALT, KC_RCTL, KC_4,    KC_LEFT, KC_NO,   KC_DOWN, KC_RIGHT),
};
